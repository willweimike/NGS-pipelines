...
cd "xxx("replace with your directory")"
# STEP 1: Run fastqc
fastqc data/demo.fastq -o data/


# run trimmomatic to trim reads with poor quality
java -jar xxx("replace with your directory")/Trimmomatic-0.39/trimmomatic-0.39.jar SE -threads 4 xxx("replace with your directory")/demo.fastq xxx("replace with your directory")/demo_trimmed.fastq TRAILING:10 -phred33
